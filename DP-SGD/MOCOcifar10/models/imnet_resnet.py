'''Refer to https://github.com/shuqike/transfer_learning/blob/main/unlabeled_extrapolation/models/imnet_resnet.py'''
...
class ResNet50(nn.Module):
    ...
    def freeze_bottom_k(self, k):
        ...
        for i in range(k):
            model_utils.set_requires_grad(layers[i], False)
