...
train_loader = DataLoader(train_dataset, batch_size=args.lpbs, shuffle=True)
test_loader = DataLoader(test_dataset, batch_size=args.ftbs, shuffle=False)
...
if args.lpgamma != -1:
    scheduler = torch.optim.lr_scheduler.ExponentialLR(optimizer, gamma=args.lpgamma)
privacy_engine = PrivacyEngine(
    model,
    batch_size=args.lpbs,
